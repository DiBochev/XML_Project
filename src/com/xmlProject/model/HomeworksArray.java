...
public class HomeworksArray {
	...
	/**
	 * @return next element if current element is 2 getNextElement() will return 3-rd element
	 */
	public Homework getNextElement(){
        ...
        /**
         * @return previous element if current element is 2 getPreviousElement() will return 2-nd element
         */
